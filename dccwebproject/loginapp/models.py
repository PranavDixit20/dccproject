...
class callallocate(models.Model):
    ...
    comp_problem = models.TextField(null=True,blank=True)
    call_alloc_date = models.DateTimeField(auto_now_add=True, editable=False,null=True,blank=True)
    call_alloc_time = models.TimeField(null=True,blank=True)
    call_alloc_engg_name = models.CharField(max_length=20,null=True,blank=True)
    ...
    call_closed_date = models.DateField(default=datetime.now,blank=True)
    engg_longitude = models.DecimalField(max_digits=20, decimal_places=2,null=True,blank=True)
    engg_latitude = models.DecimalField(max_digits=20, decimal_places=2,null=True,blank=True)
    call_type = models.CharField(max_length=7,null=True,blank=True)
    cust_ratings = models.IntegerField(null=True,blank=True)
    cust_city = models.CharField(max_length=20,null=True,blank=True)
    call_auto_close_date = models.DateField(null=True,blank=True)
    ...
    call_images_uploaded = models.ImageField(upload_to = 'co_pic/',null=True,blank=True)
    part_pickup_date = models.DateField(null=True,blank=True)
    part_delivery_date = models.DateField(null=True,blank=True)
    part_name = models.CharField(max_length=100,null=True,blank=True)
    part_number = models.IntegerField(null=True,blank=True)
    part_apply_date = models.DateField(null=True,blank=True)
    part_description = models.CharField(max_length=200,null=True,blank=True)
    part_warranty = models.IntegerField(null=True,blank=True)
    product = models.CharField(max_length=100,null=True,blank=True)
    call_prioriy = models.CharField(max_length=7,null=True,blank=True)
    engg_call_start_time = models.TimeField(null=True,blank=True)
    engg_call_end_time = models.TimeField(null=True,blank=True)
    engg_job_start_time = models.TimeField(null=True,blank=True)
    engg_job_end_time = models.TimeField(null=True,blank=True)
    engg_probelm_solve_msg = models.TextField(null=True,blank=True)
    engg_rating = models.IntegerField(null=True,blank=True)
    engg_feedback = models.TextField(null=True,blank=True)
    engg_status = models.CharField(max_length=30,null=True,blank=True)
    caller_name = models.CharField(max_length=50,null=True,blank=True)
    engg_id = models.IntegerField(null=True,blank=True)
    client_sign_image = models.ImageField(upload_to = 'sign_pic/',null=True,blank=True)
    client_image =  models.ImageField(upload_to = 'client_pic/',null=True,blank=True)

    def get_absolute_url(self):
        return reverse("loginapp:callalloclist", kwargs={'pk':self.pk})
